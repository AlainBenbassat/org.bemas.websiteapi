...
/**
 * Bemaswebsite.Updatecontact API specification (optional)
 ...
 */
function _civicrm_api3_bemaswebsite_Updatecontact_spec(&$spec) {
  $spec['magicword']['api.required'] = 1;
}

/**
 * Bemaswebsite.Updatecontact API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_bemaswebsite_Updatecontact($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Bemaswebsite', 'Updatecontact');
  }
  else {
