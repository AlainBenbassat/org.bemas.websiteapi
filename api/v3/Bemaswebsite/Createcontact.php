...
/**
 * Bemaswebsite.Createcontact API specification (optional)
...
/**
 * Bemaswebsite.Createcontact API
 *
 * @param array $params
 *
 * @return array
...
function civicrm_api3_bemaswebsite_Createcontact($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Bemaswebsite', 'Createcontact');
  }
  else {
