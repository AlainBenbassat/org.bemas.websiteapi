...
/**
 * Bemaswebsite.Getcontactbyuid API specification (optional)
...
/**
 * Bemaswebsite.Getcontactbyuid API
 *
 * @param array $params
 *
 * @return array
...
function civicrm_api3_bemaswebsite_Getcontactbyuid($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Bemaswebsite', 'Getcontactbyuid');
  }
  else {
