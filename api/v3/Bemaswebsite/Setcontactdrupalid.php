...
/**
 * Bemaswebsite.Setcontactdrupalid API specification (optional)
 ...
 */
function _civicrm_api3_bemaswebsite_Setcontactdrupalid_spec(&$spec) {
  $spec['magicword']['api.required'] = 1;
}

/**
 * Bemaswebsite.Setcontactdrupalid API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_bemaswebsite_Setcontactdrupalid($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Bemaswebsite', 'Setcontactdrupalid');
  }
  else {
